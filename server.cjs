...
${cleanMessage}`)}`;
      return res.json({
        success: true,
        message: emailForwarded ? "Your message has been delivered directly to gawadeshubham859@gmail.com!" : "Message submitted successfully! An instant email notification has been dispatched to gawadeshubham859@gmail.com.",
        ticketId,
  ...
  function getContextualAiResponse(prompt) {
  ...
  const handleRyukAiRequest = async (req, res) => {
    try {
